                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Outstanding</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Complete Payment For OrderID :<span
                            id="orderID"></span></h5>
                    </h5>
                ...
                <div class="modal-body">
                    <form id="paymentForm">
                        <div class="form-group">
                            <input type="hidden" name="orderID" value="" id="OrderID2">
...
?>
        ...
        <script src="<?php echo base_url();?>assets/customJS/Outstanding.js"></script>
