                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Service Request</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <form id="serviceForm">
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Request Type(New)</label> 
                                    <div class="col-md-10">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="search"  required name="subject">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-email-input" class="col-md-2 col-form-label">Description</label>
                                    <div class="col-md-10">
                                        <textarea class="form-control" type="email" rows="4"
                                        required name="description"></textarea>
                                    </div>
                                </div>
                              
                                <div class="mb-3 row">
                                    <label for="example-tel-input" class="col-md-2 col-form-label">Upload</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="file" required name="servicePhoto">
                                    </div>
                                </div>

                                <div class="mb-3 row">
                                <div class="col-md-12 ">
                                    <button style="float:right;" class="btn btn-primary btn-block ">Submit Request</button>
                                    </div>
                                </div>
                              </form>
...
?>
        ...
        <script src="<?php echo base_url();?>assets/customJS/ServiceRequest.js"></script>
