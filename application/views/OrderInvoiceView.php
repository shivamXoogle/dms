...
<div class="h-100">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="invoice-title">
                                                        <h4 class="float-end font-size-16" style="color:#000;">Order #
                                            ...
                                            height="30">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <address>
                                                                <strong style="color:#000;">Billed To:</strong>
                                                                <br />
                                                                <div id="billedTo" style="color:#000;">
                                                        ...
                                                        <div class="col-6 text-end">
                                                            <address>
                                                                ...
                                                                <span style="color:#000;" id="orderDate">October 16,
                                                                    2019</span><br><br>
                                                                <strong style="color:#000;">Order Amount:</strong><br>
                                                                <span style="color:#000;" id="orderAmount">October 16,
                                                                    2019</span><br><br>
                                                            </address>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="py-2 mt-3">
                                                        <h3 class="font-size-15 fw-bold">Ordered Products</h3>
                                                    </div>
                                                    <div class="table-responsive">
                                                        <table class="table table-nowrap text-center">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="color:#000;" class="text-end">Quantity
                                                                    </th>
                                                                    <th style="color:#000;" class="text-end">Price</th>
                                                        ...
                                                        <b>
                                                            <p style="color:#000;" align="right">Coupon Discount
                                                                Applied: <span id="coupounDiscount"></span> </p>
                                                        </b>
                                                        <b>
                                                            <p style="color:#000;" align="right">Total Amount Paid:
                                                    ...
                                                    <div class="d-print-none">
                                                        <div class="float-end">
                                                            <a href="<?php echo base_url().'Welcome/Invoice';?>"
                                                                class="btn btn-success waves-effect waves-light"><i
                                                                    class='bx bxs-left-arrow'></i> Back to Invoice</a>
                                                            <button id="completePaymentBtn" data-toggle="modal"
                                                                data-target="#examplePaymentModal"
                                                                class="btn btn-primary w-md waves-effect waves-light">Complete
                                                                Payment</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="examplePaymentModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Complete Payment For OrderID :
                        <?php echo $_GET['OrderID']; ?>
                    </h5>
                ...
                <div class="modal-body">
                    <form id="paymentForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" required class="form-control" name="paymentImg">
                        </div>
                        <div class="form-group">
                            <label>What Amount You are Paying</label>
                            <input type="number" required class="form-control" name="amountPaid">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mt-3">
                            <div class="spinner-border" role="status" id="paymentSpinner" style="display:none">
...
?>
        ...
        <script src="<?php echo base_url();?>assets/customJS/OrderInvoice.js"></script>
