...
<div class="h-100">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Warranty and Claim</h4>
                                        ...
                                        <table class="table mb-0 table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>View Products</th>
                                                    <th>Order Amount </th>
                                                    <th>Claim Warranty Initiation</th>
    ...
    <div class="modal fade" id="warrantModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Claim Warranty Initiation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="wararntyForm">
                        <div class="form-group">
                            <label>Upload Product Picture</label>
                            <input type="hidden" name="orderID">
                            <input type="file" class="form-control" placeholder="Upload" name="clainAvatar" required>
                        </div>
                        <div class="form-group">
...
?>
    ...
    <script src="<?php echo base_url();?>assets/customJS/Warranty.js"></script>
