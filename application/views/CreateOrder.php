            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Create Order</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active">
                                            <a href="<?php echo base_url().'Welcome/Cart'?>" type="button"
                                                class="btn btn-primary">CART <i class='bx bxs-cart'></i> <span
                                                    class="badge badge-light" id="totalCartItems"></span></a>
                                        </li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                placeholder="Search products By Name and Price" id="productSearch">
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <select class="form-control" id="productLimit">
                    ...
                    <div class="row mt-2 ">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mt-4" id="productsData">
...
?>
    ...
    <script src="<?php echo base_url();?>assets/customJS/Order.js"></script>
