                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18">Return Orders</h4>
                ...
                <div class="modal-body">
                    <form id="returnForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Reason for Return" required>
                        </div>
                        <div class="form-group mt-3">
                            <button class="btn  btn-primary" style="float:right;" type="submit">Initiate</button>
                        </div>
                    </form>
                </div>
            </div>
...
?>
    ...
    <script src="<?php echo base_url();?>assets/customJS/ReturnOrder.js"></script>
