            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="row mt-2 ">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mt-4" id="cartProducts">

                                </div>
                                <div class="row">
                                    <div class="col-xl-12  p-2">
                                        <h4 align="right">Total Price:<span id="totalAmount"></span></h4>

                                        <button type="button" style="float:right" class="btn btn-primary"
                                            id="CreateOrder">Place Order</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" id="orderSumClose" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row " id="cartProductsSummary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-left">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="couponApply">
                            </div>
                            <h4 class="mt-3">Total Amount: <span id="totalAmount2"></span></h4>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="spinner-border" role="status" id="orderSpinner" style="display:none">
...
?>
    ...
    <script src="<?php echo base_url();?>assets/customJS/CartView.js"></script>
